        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img id="aboutImage" src={require("../../assets/images/left-image.webp")} onError={e => e.target.src =require("../../assets/images/left-image.png")} class="rounded img-fluid d-block mx-auto" alt="App"></img>
                </div>
